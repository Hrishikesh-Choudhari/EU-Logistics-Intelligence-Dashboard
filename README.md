...
Python, PySpark, Apache Spark, Delta Lake, Databricks, SQL, Power BI

Tech Stack used while delivering same project in Amazon:
AWS Redshift, AWS S3, AWS Lambda, AWS SNS, AWS SQS, AWS IAM, Code.Amazon (Equvivalent of Github), Python, PySpark, Apache Spark, Delta Lake, DataCentral - ETL Manager (Equvivalent of Databricks, DBT, AWS Glue), SQL, Quicksight, Pyramid (Equvivalent of Airflow)
